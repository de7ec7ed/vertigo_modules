...
#ifndef __S5L8930MOD_UART_H__
#define __S5L8930MOD_UART_H__
...
typedef union uart_generic_register uart_divisor_slot_register_t;
...
struct uart_block {
	...
	uart_divisor_slot_register_t udivslot;
