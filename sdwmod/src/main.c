...
result_t init_c(void) {
	...
	CHECK_SUCCESS(sdw_init(), "unable to initialize the shadow module", FAILURE, main_dbg, DBG_LEVEL_2)
		return FAILURE;
	CHECK_END
...
result_t fini_c(void) {
	...
	CHECK_SUCCESS(sdw_fini(), "unable to finish the shadow module", FAILURE, main_dbg, DBG_LEVEL_2)
		return FAILURE;
	CHECK_END
